    ...
    public void ChangeText() { // change speech text of characters and options
        ...
        switch(next){
            ...
            case 1:
                ...
                uiSpeech.text = "Officer Octavia: Hey-hey, I see you! You can only earn energy resources, if you're working.. Oh wait, you look new here, my analogies, but maybe you will help out anyway?";
            ...
            case 2:
                ...
                uiSpeech.text = "Officer Octavia: Here's your chance to earn some extra energy resources. There are over 500 different tasks in the Liver, and it requires energy for doing all this. You'll get a handsome share of what you collect, and we will get a healthy Liver. Do you understand?";
            ...
            case 4:
                if (optionNum == 1) {
                    optionBox1.SetActive(false);
                    optionBox2.SetActive(false);
                    uiSpeech.text = "Officer Octavia: Let's get to work then. (add casino stuff here!!!!!)."; // add text!!
                    next = 5;
                }
                else if (optionNum == 2) {
                    optionBox2.SetActive(false);
                    uiSpeech.text = "Officer Octavia: You earn oxygen for your Red Blood Cells and proteins for your Plasma Cells. When you collect these energy resources, you should think of what is good for the body.";                   
                }
                break;
            case 5:
