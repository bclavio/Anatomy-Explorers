...
public class ChangeKidney : MonoBehaviour {
    ...
    public static Text uiSpeech, uiOption1, uiOption2, uiOption3, uiOption4;
    public static Image charObj1, charObj2, charObj3, charObj4;
    ...
    public void ChangeText() { // change speech text of characters and options
        ...
        switch (next) {              
            case 0:
                uiSpeech.text = "Pressure Peter: What are you doing here? Arhh, I don't have time for this! I don't know what to do with the high blood pressure.. Wait a second, are you here to help?";
                optionBox3.SetActive(false);
                optionBox4.SetActive(false);
                charObj2.enabled = false;
                charObj3.enabled = false;
            ...
            case 2:
                if (optionNum <= 1) {
                    optionBox1.SetActive(false);
                    uiSpeech.text = "Pressure Peter: I don't know. The blood pressure is too high. I can't get it down. Oh my, oh my, what do I do.. Wait, you blood cells are great at solving problems, you can help me!";
                    Debug.Log("work");
                    ...
                    optionBox1.SetActive(false);
                    optionBox2.SetActive(false);
                    uiSpeech.text = "Pressure Peter: Talk to the other micro-organisms here in the Kidney and figure out how to lower the blood pressure.";
            ...
            case 4:
                if (characterNum == 1) { // ASK SAL
                    ...
                    uiSpeech.text = "Salty Sal: What do you want? Can't you see I'm busy salting up this place?";
                    ...
                    uiSpeech.text = "Fit Frida: Hello, hello, I'm Frieda and I love to run, dance, push ups and all things that gets me in good shape. Who are you, and how can I help you?";
                    ...
                    charObj2.enabled = false;
                    charObj3.enabled = false;
                    uiSpeech.text = "Smokey Sam: Hello *kopf* *kopf*, I'm Smokey Sam *kopf*! I can't really see you through the all the smoke, but if you can tell me what you want, I might be able to help you.";
            ...
            case 6:
                ...
                if (characterNum == 1 && optionNum == 1) { // Option Sal.1: Who are you?
                    uiSpeech.text = "Salty Sal: Who am I? Well I'm just a whole lot of salt, having a skedaddle here. Why are you asking?";
                    ...
                    optionBox2.SetActive(false);
                    optionBox3.SetActive(false);
                    uiSpeech.text = "Salty Sal: Go on then, and don't come back unless it's important!";
                ...
                ///////////////////////// FRIEDA /////////////////////////
                    ...
                    optionBox1.SetActive(false);
                    uiSpeech.text = "Fitness Frida: Good question, but I am not sure. One thing I know is that all this salt is clustering the room in here, so it's hard to excersice. What do you suggest I do?";
                    ...
                    optionBox1.SetActive(false);
                    optionBox3.SetActive(false);
                    uiSpeech.text = "Fit Frida: You bet I can! Here we go.";
                    ...
                    optionBox2.SetActive(false);
                    optionBox3.SetActive(false);
                    uiSpeech.text = "Fit Frida: Okay, I will stop for now then.";
                ...
                ///////////////////////// SAM /////////////////////////   
                    ...
                    optionBox3.SetActive(false);
                    optionBox4.SetActive(false);
                    uiSpeech.text = "Smokey Sam: So long, mate.";
                    ...
                    optionBox3.SetActive(false);
                    optionBox4.SetActive(false);
                    uiSpeech.text = "Smokey Sam: Smokey Sam: Well I have thought and tried many times *kopf*, but it is very hard when you have smoked as long as I have. However if you think that i should *kopf* stop, then I will try much harder this time.";
                    ...
                    optionBox4.SetActive(false);
                    uiSpeech.text = "Smokey Sam: All I know is that it gets harder to stop *kopf* *kopf*, the longer you do it. And it smells horrible, right?";
                    ...
                    optionBox3.SetActive(false);
                    optionBox4.SetActive(false);
                    uiSpeech.text = "Smokey sam: Blood pressure *kopf*! That I do NOT care about. *kopf* As long as I don't have to exercise *kopf*.";
            ...
            case 9:
                ...
                if (characterNum == 1 && characterCtrl == 2 && optionNum == 1) { // Option Sal.1.1: Do you know anything about high blood pressure?
                    uiSpeech.text = "Salty Sal: I have heard somewhere, that it might help if you excercise once in a while. But honestly I don't really care.";
                    optionBox1.SetActive(false);
                    ...
                    uiSpeech.text = "Salty Sal: Don't mind if I do.";
                    ...
                    optionBox3.SetActive(false);
                    optionBox4.SetActive(false);
                    uiSpeech.text = "Salty Sal: Hmmm, well I don't want to, but if you really think I should, then I suppose I could stop spreading salt?";
                ...
                ///////////////////////// FRIEDA /////////////////////////
                    ...
                    optionBox1.SetActive(false);
                    optionBox3.SetActive(false);
                    uiSpeech.text = "Fit Frida: You are definitely right! I will excercise until the salt is gone! Thank you for the awesome advice."; // 
                ...
                ///////////////////////// SAM /////////////////////////
                    ...
                    optionBox3.SetActive(false);
                    optionBox4.SetActive(false);
                    uiSpeech.text = "Smokey Sam: I might be able to do it.";
                    ...
                    optionBox3.SetActive(false);
                    optionBox4.SetActive(false);
                    uiSpeech.text = "Smokey Sam: I'm so sorry *kopf* *kopf*. I will stop smoking now then. You guys should not be affected by my choice *kopf*. However, it was nice to meet you guys and good luck on your journey.";
            ...
            case 10:
                if (characterCtrl == 3 && optionNum == 1) { // High blood pressure
                    ...
                    optionBox2.SetActive(false);
                    optionBox3.SetActive(false);
                    uiSpeech.text = "Pressure Peter: OH NO NO NO! The blood pressure is even higher now. Please go fix this! Im so STRESSED.";
                    ...
                    if (doneSal && doneFrieda && doneSam) {
                        ...
                        optionBox2.SetActive(false);
                        optionBox3.SetActive(false);
                        uiSpeech.text = "Pressure Peter: Pheeeew, what a relief. Now the blood pressure is more stabilized. Thank you so much.";
                        ...
                        optionBox1.SetActive(false);
                        optionBox3.SetActive(false);
                        uiSpeech.text = "Pressure Peter: Brilliant! Hurry, get the others to help too.";
